...
} from "https://deno.land/x/discord_api_types@0.37.45/v10.ts";
export {
...
export { isChatInputApplicationCommandInteraction } from "https://deno.land/x/discord_api_types@0.37.45/utils/v10.ts";
